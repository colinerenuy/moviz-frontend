...
const movies = moviesData.map((data, i) => {
  return <Movie updateLikedMovies={updateLikedMovies} isLiked={likedMovies.includes(data.title)} key={i} title={data.title} overview={data.overview} poster={data.poster} voteAverage={data.voteAverage} voteCount={data.voteCount} />;
  });
